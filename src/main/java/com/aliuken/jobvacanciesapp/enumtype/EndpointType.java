...
public enum EndpointType implements Serializable {
	...
	AUTH_USER_EXPORT_TO_PDF(GET, "/auth-users/index/exportToPdf", "Export user list to PDF"),
	...
	AUTH_USER_JOB_REQUEST_EXPORT_TO_PDF(GET, "/auth-users/job-requests/([^/]+)/exportToPdf", "Export user job request list to PDF"),
	...
	JOB_CATEGORY_EXPORT_TO_PDF(GET, "/job-categories/index/exportToPdf", "Export job category list to PDF"),
	...
	JOB_CATEGORY_JOB_VACANCY_EXPORT_TO_PDF(GET, "/job-categories/job-vacancies/([^/]+)/exportToPdf", "Export job category job vacancy list to PDF"),
	...
	JOB_COMPANY_EXPORT_TO_PDF(GET, "/job-companies/index/exportToPdf", "Export job company list to PDF"),
	...
	JOB_COMPANY_JOB_VACANCY_EXPORT_TO_PDF(GET, "/job-companies/job-vacancies/([^/]+)/exportToPdf", "Export job company job vacancy list to PDF"),
	...
	JOB_COMPANY_JOB_COMPANY_LOGO_EXPORT_TO_PDF(GET, "/job-companies/job-company-logos/([^/]+)/exportToPdf", "Export job company job company logos list to PDF"),
	...
	JOB_REQUEST_EXPORT_TO_PDF(GET, "/job-requests/index/exportToPdf", "Export job request list to PDF"),
	...
	JOB_VACANCY_EXPORT_TO_PDF(GET, "/job-vacancies/index/exportToPdf", "Export job vacancy list to PDF"),
	...
	JOB_VACANCY_JOB_REQUEST_EXPORT_TO_PDF(GET, "/job-vacancies/job-requests/([^/]+)/exportToPdf", "Export job vacancy job request list to PDF"),
	...
	SESSION_AUTH_USER_CURRICULUM_EXPORT_TO_PDF(GET, "/my-user/auth-user-curriculums/exportToPdf", "Export session user curriculum list to PDF"),
	...
	SESSION_AUTH_USER_ENTITY_QUERY_EXPORT_TO_PDF(GET, "/my-user/auth-user-entity-queries/exportToPdf", "Export session user entity query list to PDF"),
	...
	SESSION_AUTH_USER_JOB_REQUEST_EXPORT_TO_PDF(GET, "/my-user/job-requests/exportToPdf", "Export session user job request list to PDF"),
	...
	private EndpointType(final @NonNull HttpMethod httpMethod, final @NonNull String pathRegex, final @NonNull String description) {
	...
	private static @NonNull Map<EndpointRegexPatternDTO, EndpointType> getEndpointTypeMap() {

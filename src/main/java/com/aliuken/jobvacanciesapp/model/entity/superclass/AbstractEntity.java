...
public abstract class AbstractEntity implements Serializable, Comparable<AbstractEntity>, AbstractEntityFieldsPrintable {
	...
	public String getCommonFields() {
		...
		final String result = StringUtils.getStringJoined(
			StyleApplier.getBoldString("insertDate: "), firstRegistrationDateTimeString, "\n",
			StyleApplier.getBoldString("insertMail: "), firstRegistrationAuthUserEmail, "\n",
			StyleApplier.getBoldString("updateDate: "), lastModificationDateTimeString, "\n",

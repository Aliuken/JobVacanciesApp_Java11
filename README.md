...
> - Storing in the DB the user **mobile phone number** to implement **two-factor authentication by sending an SMS** (with a random authentication code). This feature could be optional by configuration.

...
> [!IMPORTANT]
> The folder [build-context-app](https://github.com/Aliuken/JobVacanciesApp_Java11/blob/main/build-context-app) is the build context of the Docker Compose for the app and contains:

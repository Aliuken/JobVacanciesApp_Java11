...
* **Bootstrap 5.3.3** and **Material Design for Bootstrap 8.2.0**: For the look-and-feel.
...
A possible improvement could be to generate the JS files **ajax-utils.js**, **page-url-utils.js** and **page-dom-utils.js** by compiling equivalent TS files (named **ajax-utils.ts**, **page-url-utils.ts** and **page-dom-utils.ts**) using the [TypeScript Playground](https://www.typescriptlang.org/play/) (so that we don't need to install "Node.js", "npm" and "TypeScript").
...
* **/AppData_Java11/JobVacanciesApp** is the folder that has the **CVs**, **query PDFs**, **company logos** and **log files** used in the application.

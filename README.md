...
* **TinyMCE Community 7.6.0**: For the rich text editor.
...
> [!NOTE]
> The decorator [template.html](https://github.com/Aliuken/JobVacanciesApp_Java11/blob/main/src/main/resources/templates/fragments/mandatory/template.html) calls the JS function **getIsPageWithTable()** of [page-dom-utils.js](https://github.com/Aliuken/JobVacanciesApp_Java11/blob/main/src/main/resources/static/jobvacanciesapp-utils/js/page-dom-utils.js) (to check if the current page has a table) and has the following Thymeleaf fragments:
...
* **Docker Compose for the Elastic Stack** (in [build-context-elk/docker-compose.yaml](https://github.com/Aliuken/JobVacanciesApp_Java11/blob/main/build-context-elk/docker-compose.yaml)). It uses:
    * The **Elastic Stack 8.17.0** Docker images (url: <https://www.docker.elastic.co>): For analyzing the app log files, which pass through the stack in the next order: "Filebeat **&rArr;** Logstash **&rArr;** Elasticsearch **&rArr;** Kibana".

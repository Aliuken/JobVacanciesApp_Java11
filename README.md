...
* Its variables are configured in the file [docker-compose-app/.env](https://github.com/Aliuken/JobVacanciesApp_Java11/blob/main/build-context-app/.env) overriding the default values.
